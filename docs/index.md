...
Welcome to the **Family Tree API Documentation** – a powerful D3.js-based visualization library for creating beautiful, interactive family trees (forked from Family Chart).
...
The Family Tree library is built around three core classes that work together:
...
- [GitHub Repository (amont)](https://github.com/donatso/family-chart)
