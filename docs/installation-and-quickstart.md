...
This guide will help you get started with Family Tree in just a few minutes.
...
```html
<script src="https://unpkg.com/family-tree@latest/dist/family-tree.min.js"></script>
...
<script>
import * as f3 from 'family-tree';
import 'family-tree/styles/family-tree.css';
...
- 🎨 **[Examples](https://donatso.github.io/family-chart-doc/examples/)** - Browse more examples (ressources amont)
- 🎨 **[Visual Builder](https://donatso.github.io/family-chart-doc/create-tree/)** - Generate code with the visual builder (ressources amont)
- 📚 **[API Reference](https://donatso.github.io/family-chart/)** - Complete API documentation (héritée)
...
2. **D3 errors**: Ensure D3.js is loaded before Family Tree
...
- Report issues on [GitHub](https://github.com/donatso/family-chart/issues) (amont)
