...
function attachPanelControls({ chart, card }) {
  ...
  function setMainProfile(id, {
    ...
    // Update SourceManager context
    if (sourceManager && typeof sourceManager.setContext === 'function') {
      sourceManager.setContext(id)
    }
...
async function initialise() {
  ...
  try {
    ...
    if (sourceContainer) {
      ...
      // Set initial context if mainId is available
      if (chartConfig.mainId) {
        sourceManager.setContext(chartConfig.mainId)
      }
